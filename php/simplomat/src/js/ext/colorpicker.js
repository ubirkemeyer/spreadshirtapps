    ...
    var doc = document, win = window,
        ColorPicker = function (x, y, size, initcolor, element) {
            ...
            t.disc.drag(function (dx, dy, x, y) {
                ...
                var scrollY = 0, //doc.documentElement.scrollTop || doc.body.scrollTop,
                    scrollX = 0; //doc.documentElement.scrollLeft || doc.body.scrollLeft;*/
                t.hsOnTheMove = true;
            ...
            t.btop.drag(function (dx, dy, x, y) {
                ...
                var scrollX = 0; //doc.documentElement.scrollLeft || doc.body.scrollLeft;
                t.bOnTheMove = true;
