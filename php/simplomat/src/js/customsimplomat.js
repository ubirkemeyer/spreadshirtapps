function CustomSimplomat() {
    ...
    this.customCreateActionButtons = function () {
        ...
        this.butt[0].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
        ...
        this.butt[1].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke:  simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
        ...
        this.butt[2].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke:  simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
        ...
        this.butt[3].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
        ...
        this.butt[4].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
                this.R.path(new Path(this.relativeScaleFactor).M(5.0, 24.00).L(45.0, 24.00).L(45.0, 29.0).L(5.0, 29.0).L(5.0, 24.0).M(22.5, 5.00).L(22.5, 45).L(27.5, 45).L(27.5, 5).L(24, 5).Z().path).attr({stroke: "none", fill: simplomat.textColor}),
                this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({fill: simplomat.boxFillColor, opacity: 0}));
        ...
        this.butt[5].push(this.R.circle(24.833 * this.relativeScaleFactor, 26.917 * this.relativeScaleFactor, 26.667 * this.relativeScaleFactor).attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
    ...
    this.customCreateViewButtons = function() {
        ...
        for (var i = 0; i < this.product.views.length; i++) {
            ...
            this.viewButt[i].push(this.R.rect(0, 0, 50 * this.relativeScaleFactor, 50 * this.relativeScaleFactor).attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
    ...
    this.customCreateSizeButtons = function() {
        ...
        for (var i = 0; i < this.product.sizes.length; i++) {
            ...
            this.sizeButt[i].push(this.R.rect(0, 0, 53 * this.relativeScaleFactor, 30 * this.relativeScaleFactor)
                    .attr({stroke: simplomat.boxStrokeColor, fill: simplomat.boxFillColor, "fill-opacity": .4, "stroke-width": 2, "cursor": "pointer"}),
    ...
    this.customCreatePriceLabel = function() {
        ...
        this.priceLabel = this.R.text(0, 0, "" + this.product.getFormatedPrice()).attr({"font-size": Math.round(25 * this.relativeScaleFactor), "font-weight": "bold"});
    ...
    this.customCreateBuyButton = function() {
        ...
        this.buyButton.push(this.R.rect(0, 0, 170 * this.relativeScaleFactor, 30 * this.relativeScaleFactor).attr({stroke: this.boxStrokeColor, fill: this.boxFillColor, "fill-opacity": .4, "stroke-width": 2}),
        ...
        this.buyButton[1].click(function () {
            if (this.clickable) {
        ...
        this.buyButton[0].click(function () {
            if (this.subject.clickable) {
                this.simplomat.createProductAndCheckout();
            }
        }).mouseover(function () {
