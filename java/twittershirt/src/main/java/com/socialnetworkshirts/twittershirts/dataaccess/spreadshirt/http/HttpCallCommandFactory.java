...
public class HttpCallCommandFactory {
    ...
    public HttpCallCommand createStreamHttpCallCommand(String url, HttpMethod method,
                                                       HttpMethod tunneledMethod) {
        return new StreamHttpCallCommand(connectionFactory, url, method, tunneledMethod, false, false, false);
    }

    public HttpCallCommand createSvgUploadCommand(String url, HttpMethod method,
                                                  HttpMethod tunneledMethod) {
        return new SvgUploadCommand(connectionFactory, url, method, tunneledMethod, false, false, false);
    }
}
